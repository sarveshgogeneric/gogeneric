        ...
        <div class="slide-item align-v-h">
          ...
          <div class="container">
            <div class="row align-items-center">
              <div class="col-sm-12 col-md-12 col-lg-12 col-xl-8 offset-xl-2">
                <div class="slide__content">
                  <h2 class="slide__title color-white">Tech Enabled Supply Chain</h2>
        ...
        <div class="slide-item align-v-h">
          ...
          <div class="container">
            <div class="row align-items-center">
              <div class="col-sm-12 col-md-12 col-lg-12 col-xl-8 offset-xl-2">
                <div class="slide__content">
                  <h2 class="slide__title color-white">Patient Counselling </h2>
                  <p class="slide__desc color-white">For Best Treatment Options</p>
                  <div class="d-flex flex-wrap justify-content-center align-items-center">
                    <a href="about-us.html" class="btn btn__white btn__rounded mr-30">
                      <span>More About Us</span>
                      <i class="icon-arrow-right"></i>
        ...
        <div class="row">
          <div class="col-sm-12 col-md-12 col-lg-6 offset-lg-3">
            <div class="heading text-center mb-40">
              ...
              <h3 class="heading__title">The Largest Selections Of Generic Medicine Products</h3>
            </div><!-- /.heading -->
          </div><!-- /.col-lg-6 -->
        </div><!-- /.row -->
        <div class="row">
          ...
          <div class="col-sm-6 col-md-6 col-lg-3">
            <div class="product-item">
              ...
              <div class="product__info">
                <h4 class="product__title"><a href="#">Paracetamol</a></h4>
          ...
          <div class="col-sm-6 col-md-6 col-lg-3">
            <div class="product-item">
              ...
              <div class="product__info">
                <h4 class="product__title"><a href="#">Cefixime</a></h4>
          ...
          <div class="col-sm-6 col-md-6 col-lg-3">
            <div class="product-item">
              ...
              <div class="product__info">
                <h4 class="product__title"><a href="#">Calmin</a></h4>
    ...
    <section class="banner-layout2 py-0">
      ...
      <div class="container">
        <div class="row">
          <div class="col-sm-12 col-md-12 col-lg-6">
            <div class="banner-text">
              <div class="heading-layout2 heading-light">
                ...
                <p class="heading__desc mb-40">Today the store is recognised as a world renowned institution, not
                  only providing outstanding medicine facilities, our goal is to deliver quality care in a respectful &
          ...
          <div class="col-sm-12 col-md-12 col-lg-6 baner-img add">
            <div class="bg-img star ">
