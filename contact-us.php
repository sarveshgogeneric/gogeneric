<?php include 'header.php';?>
    ...
    <section class="google-map py-0">
      <iframe frameborder="0" height="500" width="100%"
        src="https://maps.google.com/maps?q=Suite%20100%20Gaur%20City%2C%20Mall%2094107%20Noida%&amp;t=m&amp;z=10&amp;output=embed&amp;iwloc=near"></iframe>
    </section><!-- /.GoogleMap -->
              ...
              <div
                ...
                <div>
                  <ul class="contact__list list-unstyled mb-30">
                    <li>
                      <i class="icon-phone"></i><a href="tel:+918669040052">OnLine: 866 904 0052</a>
                    </li>
                    <li>
                      <i class="icon-location"></i><a href="#">Location: Noida, Uttar Pradesh</a>
                    </li>
                    <li>
